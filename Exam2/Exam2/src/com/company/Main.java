...
public class Main {
    ...
    public static void menu() throws UnknownHostException, IOException {
        ...
        do {
            ...
            switch (keyInput) {
                ...
                case 5:
                    support.clearScreen();
                    System.out.println("5. Input Edit Delete From DB");
                    menu5();
                    support.pressAnyKeyToContinue();
                    break;
                case 6:
    ...
    public static void menu5() throws UnknownHostException, IOException {
        int keyInput;
        do {
            support.clearScreen();
